...
function checkArrows (field, evt) 
{
  ...
  return true;
    ...
    <body>
    <DIR><BR>
        <U><h4  style='color: #000000; text-decoration: none;' ID='big'>Búsqueda de clientes por nombre.</h4></U>

            <FORM id='frmSearch' action='pornombre2.php'>
                <INPUT TYPE='text' size='50' maxlength='100' id='txtSearch' name='txtSearch' alt='Búsqueda por nombre' autocomplete='off' />

                <INPUT TYPE='button' id='cmdNow' name='cmdNow' value='&raquo;' alt='Ejecutar búsqueda' onClick='searchSuggest("pornombre.php");' />
