...
?>
    ...
    <body>
    <DIR><BR>
        <U><h4  style='color: #000000; text-decoration: none;' ID='big'>Búsqueda de cliente por nombre.</h4></U>

            <FORM id='frmSearch' action='porempresa2.php'>
                <INPUT TYPE='text' size='50' maxlength='100' id='txtSearch' name='txtSearch' alt='Búsqueda por nombre' onkeyup='searchSuggest("porempresa.php");' autocomplete='off' />
