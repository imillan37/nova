        ...
        return this.each(function () {
            ...
            if (!this.grid) {
                ...
                if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                    ...
                    b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").append(u).insertBefore(q);
                    ...
                    var J = function (c, d) {
                        ...
                        if (a.p.colModel[c].hidden === true) l += "display:none;";
                        ...
                        if (b.isXMLDoc(c)) {
                            ...
                            N = (D + "").indexOf("[") === -1 ? L.length ? function (W, U) {
                            ...
                            if (c && ea) {
                                ...
                                for (n = b.isFunction(a.p.afterInsertRow); O < ea;) {
                                    ...
                                    C[Q++] = '<tr id="' + V + '" role="row" class ="ui-widget-content jqgrow ui-row-' + a.p.direction + "" + p + '">';
                        ...
                        if (c) {
                            ...
                            var Q = a.p.altRows === true ? " " + a.p.altclass : "";
                    ...
                    fa = function () {
                        ...
                        s = l == "float" || l == "number" || l == "currency" ? function (r) {
                    ...
                    u = function (c, d) {
                        ...
                        b("#" + c).append("<div id='" + s + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;' role='row'><tbody><tr><td id='" + p + "' align='left'></td><td id='" + w + "' align='center' style='white-space:pre;'></td><td id='" + r + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
                        ...
                        b(".ui-pg-selbox", "#" + s).bind("change", function () {
                        ...
                        a.p.pginput === true && b("input.ui-pg-input", "#" + s).keypress(function (v) {
                    ...
                    for (j = 0; j < this.p.colNames.length; j++) {
                        ...
                        H += "<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + m + "'>";
                    ...
                    b("th", q).each(function (c) {
                        ...
                        if (a.p.colModel[c].resizable) {
                            ...
                            b(ha).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + m);

                            !b.browser.opera && b(ha).css("cursor", "col-resize");
        ...
        addRowData: function (f, k, i, h) {
            ...
            if (k) {
                ...
                this.each(function () {
                    ...
                    for (var aa = 0, ja = b.isFunction(t.p.afterInsertRow) ? true : false; aa < ia;) {
                        ...
                        case "after":
                            ...
                            if (y = t.rows.namedItem(h)) b(t.rows[y.rowIndex + 1]).hasClass("ui-subgrid") ? b(t.rows[y.rowIndex + 1]).after(m) : b(y).after(m);
                    ...
                    if (t.p.altRows === true && !F) if (i == "last")(t.rows.length - 1) % 2 == 1 && b(t.rows[t.rows.length - 1]).addClass(M);
                        ...
                        T % 2 == 1 ? b(this).addClass(M) : b(this).removeClass(M)
                ...
                b(this.p.colModel).each(function (u) {
                    ...
                    if (f == "set") {
                        ...
                        if (k[g] != undefined) {
                            ...
                            b("tr.footrow td:eq(" + u + ")", a.grid.sDiv).html(q).attr("title", b.jgrid.stripHtml(q));
...
(function (c) {
    ...
    c.fn.fmatter.select = function (a, b) {
        ...
        if (d) {
            ...
            } else if (isObject(d)) if (h) e = jQuery.map(g, function (l) {
    ...
    c.fn.fmatter.actions = function (a, b) {
        ...
        var e = "<div style='margin-left:8px;'><div title='" + c.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + d + "><span class='ui-icon ui-icon-pencil'></span></div>";
        ...
        e = e + "<div title='" + c.jgrid.edit.bSubmit + "' style='float:left;display:none' class='ui-pg-div ui-inline-save'><span class='ui-icon ui-icon-disk' " + d + "></span></div>";
    ...
    c.unformat = function (a, b, d, e) {
        ...
        var h, g = b.colModel.formatter,

            f = b.colModel.formatoptions || {}, i = /([\.\*\_\'\(\)\{\}\+\?\\])/g;

        unformatFunc = b.colModel.unformat || c.fn.fmatter[g] && c.fn.fmatter[g].unformat;

        if (typeof unformatFunc !== "undefined" && isFunction(unformatFunc)) h = unformatFunc(c(a).text(), b, a);
        ...
        sortGrid: function (d, o, b) {
            ...
            return this.each(function () {
                ...
                if (l.grid) {
                    ...
                    for (var p = 0; p < l.p.colModel.length; p++) if (l.p.colModel[p].index == d || l.p.colModel[p].name == d) {
                ...
                if (this.grid) {
                    ...
                    if (d == "hidden") {
                        ...
                        if ($t.p.toolbar[0] === true) {
                            ...
                            $t.p.toolbar[1] == "both" && a($t.grid.ubDiv).slideDown("fast");
                    ...
                    if (k = p.rows.namedItem(m[o])) {
                        ...
                        a(p.p.colModel).each(function (g) {
                            ...
                            if (m[l] != undefined) {
                                ...
                                p.p.treeGrid === true && l == p.p.ExpandColumn ? a("td:eq(" + g + ") > span:first", k).html(f).attr("title", a.jgrid.stripHtml(f)) : a("td:eq(" + g + ")", k).html(f).attr("title", a.jgrid.stripHtml(f));
                    ...
                    if (l) {
                        ...
                        if (this.p.gridModel === true) {
                            ...
                            a.each(l, function (c) {
                                ...
                                p = this.editrules && this.editrules.searchhidden === true ? true : this.hidden === true ? false : true;
                        ...
                        (function () {
                            ...
                            b.p.formtype == "horizontal" && a(e).append(c);

                            a.each(b.p.filterModel, function (q) {
                                ...
                                case "text":
                                    ...
                                    if (b.p.gridToolbar === true && i.width) a.browser.msie ? a("input", j).width(i.width - 4) : a("input", j).width(i.width - 2);
        ...
        filterToolbar: function (d) {
            ...
            return this.each(function () {
                ...
                function o(f, k) {
                    ...
                    m[0] != null && jQuery.each(k, function () {
...
function info_dialog(a, b, c, e) {
    ...
    if (f.buttons.length > 0) for (e = 0; e < f.buttons.length; e++) {
        ...
        a += "<a href='javascript:void(0)' id='" + f.buttons[e].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[e].text + "</a>"
    ...
    d += c ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:" + f.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a href='javascript:void(0)' id='closedialog' class='fm-button ui-state-default ui-corner-all'>" + c + "</a>" + a + "</div>" : "";
...
function checkValues(a, b, c) {
    ...
    if (e) {
        ...
        if (e.number === true) if (!(f === false && isEmpty(a))) if (isNaN(a)) return [false, h + ": " + jQuery.jgrid.edit.msg.number, ""];
        ...
        if (e.time === true) if (!(f === false && isEmpty(a))) if (!checkTime(a)) return [false, h + ": " + jQuery.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""];
...
function checkDate(a, b) {
    ...
    if (e === -1) return false;
        ...
        if (i.length != f || c[a[e]] == 0 && b[e] != "00") return false
                    ...
                    if (a("#" + q).html() != null) {
                        ...
                        a.each(F, function (r, v) {
                            ...
                            if (this.stype == "select") if (soptions.dataUrl == null) {
                                ...
                                else if (this.editoptions) B = this.editoptions.value;
                            ...
                            if (h.drag === true) {
                                ...
                                if (jQuery.fn.jqDrag) a("#" + q).jqDrag(a("#" + q + " table thead tr:first td:first"));
                                    ...
                                    a("#" + q).draggable({
                                        ...
                                        handle: a("#" + q + " table thead tr:first td:first")
            ...
            return this.each(function () {
                            ...
                            a.each(f.p.colModel, function () {
                                ...
                                if (this.name == l && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    ...
                                    try {
                                        ...
                                        c[l] = this.editoptions.custom_value(a("#" + l, "#" + i), "get");
                ...
                function q(g, l, C, p) {
                    ...
                    a(l.p.colModel).each(function (Y) {
                        ...
                        if (E !== "cb" && E !== "subgrid" && this.editable === true && E !== "rn") {
                            ...
                            if (f.p.autoencode) y = a.jgrid.htmlDecode(y);

                            G = createEl(this.edittype, U, y, false, a.extend({}, a.jgrid.ajaxOptions, l.p.ajaxSelectOptions || {}));
                            ...
                            if (A.length == 0) {
                                ...
                                A = a("<tr " + L + " rowpos='" + X + "'></tr>").addClass("FormData").attr("id", "tr_" + E);
                    ...
                    if (K > 0) {
                        ...
                        if (d.checkOnSubmit || d.checkOnUpdate) d._savedData.id = g
                        ...
                        if (Q) {
                            ...
                            a("td", Q).each(function (H) {
                                ...
                                if (p !== "cb" && p !== "subgrid" && p !== "rn" && G[H].editable === true) {
                                    ...
                                    if (p == l.p.ExpandColumn && l.p.treeGrid === true) z = a(this).text();
                        ...
                        a.ajax(a.extend({
                            ...
                            complete: function (y, L) {
                                ...
                                if (L != "success") {
                                    ...
                                    l[1] = a.isFunction(d.errorTextFormat) ? d.errorTextFormat(y) : L + " Status: '" + y.statusText + "'. Error code: " + y.status
                                ...
                                if (l[0] === false) {
                                    ...
                                    f.p.autoencode && a.each(c, function (Q, H) {
                ...
                if (f.grid && h) {
                    ...
                    var e = f.p.id,
                        ...
                        }, u = a.isFunction(d.beforeShowForm) ? d.beforeShowForm : false,
                    ...
                    if (a("#" + k.themodal).html() != null) {
                        ...
                        if (I > 0) {
                            ...
                            a.each(a(O)[0].rows, function (g, l) {
                        ...
                        if (d.checkOnSubmit || d.checkOnUpdate) {
                            ...
                            a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:" + N + ";display:none;'>&#160;" + (a.browser.msie && a.browser.version == 6 ? '<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>' : "") + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (N + 1) + "'>" + b.saveData + "<br/><br/>" + $ + T + aa + "</div>").insertAfter("#" + j);
        ...
        b) {
            ...
            return this.each(function () {
                ...
                function x(c, t) {
                    ...
                    c == 0 ? a("#pData", "#" + f + "_2").addClass("ui-state-disabled") : a("#pData", "#" + f + "_2").removeClass("ui-state-disabled");
                ...
                function w(c, t, J, S) {
                    ...
                    for (var M, N, D, O = 0, T, $, aa = [], V = false, ca = "<td class='CaptionTD form-view-label ui-widget-content' width='" + b.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", g = "", l = ["integer", "number", "currency"], C = 0, p = 0, E, z, A, K = 1; K <= S; K++) g += K == 1 ? ca : "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
                    ...
                    a(t.p.colModel).each(function (y) {
                        ...
                        if (M !== "cb" && M !== "subgrid" && M !== "rn" && A) {
                            ...
                            a("td:eq(" + (Q - 2) + ")", D[0]).html("<b>" + (typeof L.label === "undefined" ? t.p.colNames[y] : L.label) + "</b>");
                    ...
                    c, true)) {
                        ...
                        a("td", D).each(function (O) {
                            ...
                            if (J !== "cb" && J !== "subgrid" && J !== "rn") {
                                ...
                                a.extend({}, t.p.colModel[O].editoptions || {});
                ...
                if (n.grid && h) {
                    ...
                    if (!b.imgpath) b.imgpath = n.p.imgpath;
                    ...
                    if (a("#" + e.themodal).html() != null) {
                        ...
                        if (i > 0) {
                            ...
                            a.each(a(P)[0].rows, function (c, t) {
            ...
            return this.each(function () {
                ...
                if (o.grid) if (h) {
                    ...
                    if (a("#" + j.themodal).html() != null) {
                        ...
                        i += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + n + "_2'><tbody><tr><td class='DataTD ui-widget-content'></td></tr><tr style='display:block;height:3px;'><td></td></tr><tr><td class='DelButton EditButton'>" + ("<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>") + "&#160;" + ("<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + b.bCancel + "</a>") + "</td></tr></tbody></table>";
            ...
            return this.each(function () {
                ...
                if (this.grid) {
                    ...
                    if (o) {
                        ...
                        a(s).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='ui-icon " + b.buttonicon + "'></span>" + b.caption + "</div>");
        ...
        GridToForm: function (h, b) {
            ...
            return this.each(function () {
                ...
                if (o.grid) {
                    ...
                    if (x) for (var s in x) a("[name=" + s + "]", b).is("input:radio") || a("[name=" + s + "]", b).is("input:checkbox") ? a("[name=" + s + "]", b).each(function () {
    ...
    function C(c, i, k) {
        ...
        if (i != null) {
            ...
            function z(a, b) {
                ...
                e[0] != null && jQuery.each(b, function () {
            ...
            jQuery.each(d.groupOps, function () {
            ...
            jQuery.each(d.operators, function () {
            ...
            c.find(".ui-search").click(function () {
                ...
                var a = jQuery(c.selector),
                    ...
                    b, e = a.find("select[name='groupOp'] :selected").val();
                    ...
                    if (n != false) {
                        ...
                        if (q >= 0) {
                            ...
                            a.each(i.p.colModel, function () {
                                ...
                                if (this.editable == true && this.name in i.p.savedRow[q]) u[this.name] = i.p.savedRow[q][this.name]
    ...
    a.jgrid.extend({
                ...
                if (b.grid) {
                    ...
                    a("td:eq(" + e + ")", d).click(function () {
                        ...
                        if (a(this).hasClass("sgcollapsed")) {
                            ...
                            if (a.isFunction(b.p.subGridBeforeExpand)) p = b.p.subGridBeforeExpand(q + "_" + n, n);
                            ...
                            a.isFunction(b.p.subGridRowExpanded) ? b.p.subGridRowExpanded(q + "_" + n, n) : y(o);
                    ...
                    var y = function (g) {
                        ...
                        var f, c, h, m = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                        ...
                        if (g) {
                            ...
                            if (typeof g !== "undefined") for (c = 0; c < g.length; c++) {
                                ...
                                if (f.repeatitems === true) {
                                    ...
                                    var r = b.p.subGridModel[0].mapping || b.p.subGridModel[0].name;
        ...
        expandSubGridRow: function (d) {
            ...
            return this.each(function () {
                ...
                if (e.grid || d) if (e.p.subGrid === true) if (e = a(this).jqGrid("getInd", d, true))(e = a("td.sgcollapsed", e)[0]) && a(e).trigger("click")
        ...
        setTreeGrid: function () {
            ...
            return this.each(function () {
                ...
                if (a.p.treeGrid) {
                    ...
                    d.each(a.p.treeReader, function (e, f) {
        ...
        collectChildrenSortTree: function (a, c, b) {
            ...
            return this.each(function () {
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    var e, f, i, j = d(this).jqGrid("getNodeChildren", c);
        ...
        excelExport: function (a) {
            ...
            return this.each(function () {
                ...
                if (this.grid) if (a.exptype == "remote") {
                    ...
                    var e = b.extend({}, this.p.postData);
                                    ...
                                    drop: function (e, h) {
                                        ...
                                        if (!d.dropbyname) {
                                            ...
                                            var l = 0,
                                                ...
                                                m = {}, n, f = a("#" + this.id).jqGrid("getGridParam", "colModel");
