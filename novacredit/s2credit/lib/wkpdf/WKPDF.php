...
class wkhtmltopdf
{
    ...
    /*
    * Propiedades agregadas por Soft2Be
    * Agosto de 2012
    */
    protected $margin_top=20;
    protected $margin_bottom=20;
    protected $margin_left=25;
    ...
    public function setFooterHtml($footer)
    {
        ...
        //$this->_footerfilename = (string)$footer;
    ...
    /**
     * 
     * Funciones agregadas por Soft2Be
     * 
     * @date 16.08.2012
     * @author Hector Ivan Patricio Moreno
     * 
     */
    ...
    public function setMargin_top($margin_top)
    ...
    public function setMargin_right($margin_right)
    ...
    public function setMargin_bottom($margin_bottom)
    ...
    public function setMargin_left($margin_left)
    ...
    protected function _getCommand($in)
    {
        ...
        switch ($this->getMethod()) {
                case 'exec':
                                ...
                                $command .= " --margin-left ".$this->margin_left;
                                $command .= " --margin-right ".$this->margin_right;
                                $command .= $this->_have_headerhtml ? " --margin-top 30 --header-spacing 5 --header-html \"" . $this->_headerHtml . "\"" : " --margin-top ".$this->margin_top;
                                $command .= $this->_have_footerhtml ? " --margin-bottom 30 --footer-spacing 5 --footer-html \"" . $this->_footerHtml . "\"" : " --margin-bottom ".$this->margin_bottom;
