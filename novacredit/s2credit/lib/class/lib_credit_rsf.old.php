...
if($this->ver_detalle_de_datos_credito)
{
   ...
   $sql = "
    SELECT  CONCAT(Nombre,' ',NombreI,' ',Ap_Paterno,' ',Ap_Materno) as NombreCliente,
        ...
        echo "          <TH ALIGN='left'  WIDTH='30%'   BGCOLOR='white'      STYLE='color:black;'>".$rs->fields['Telefono']."</TH>";
...
*/
                   ...
                   //----------------------------------------------------------------------------------------
                       ...
                       echo "<TR  BGCOLOR='steelblue'  ID='small' STYLE='color:white;'>      \n";
                        ...
                        echo "<TH  ALIGN='right' Width='100px;' STYLE='color:navy;'     >".number_format($SUMA_PAGOS  , $dec)."</TH>     \n";
