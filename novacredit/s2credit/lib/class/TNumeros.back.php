...
function  aUnidad($num)
{
	...
	switch($num) 
	{
		  ...
		  case 3 :  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='dos ';   } break;
		  case 4 :  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='tres ';  } break;
		  case 5 :  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='cuatro ';} break;
		  case 6 :  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='cinco '; } break;
		  case 7 :  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='seis ';  } break;
		  case 8 :  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='siete '; } break;
		  case 9 :  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='ocho ';  } break;
		  case 10:  if( $this->cDecena=='1') { $a_Unidad = $this->aDecena(2, $this->cUnidad + 1); } else { $a_Unidad='nueve '; } break;
		  default :  $a_Unidad=' ';
	 }
return($a_Unidad);
}
