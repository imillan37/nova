...
class TInputTypeDate extends TInputType
{
        ...
        function GetScript()
        {
           ...
           $script.="$this->tab <INPUT type='text'   STYLE='text-align:center;' ".$style."  ".$enabled." ".$required." name='".$this->varname."' value='".$this->value."' size='".$this->size."' maxlength='".$this->maximun."'  ".$on_change_event." ".$on_blur_event."  ".$enabled."  ".$ronly."> \n\n ";      
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//      Clase TInputTypeTimeLite
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//


class TInputTypeTimeLite extends TInputType
{
        ...
        function TInputTypeTimeLite($sVarname_hour,$sVarname_minute) //Constructor
        {                
                $this->value_hh_name = $sVarname_hour; 
                $this->value_mm_name = $sVarname_minute;
                $this->value_ss_name = $sVarname_second;                
