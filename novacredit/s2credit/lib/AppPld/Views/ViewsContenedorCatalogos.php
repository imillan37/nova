...
<div class="ui ignored info message" style="text-align: center;"><h2>Cat�logos P.L.D. </h2></div>
...
<div class="ui blue segment" align="left">
			...
			<table align="center" width="100%" class="ui table segment">
				<tr class="positive">
					<td width="30%">D�LARES (ESTADOS UNIDOS)</td>
				...
				<tr class="positive">
					<td>UNIDADES DE INVERSI�N</td>
					<td><a class="ui mini blue button" id="UDIS">Consultar</a></td>
					<td><a class="ui mini blue button" id="UDIS_act">Actualizar</a></td>
				</tr>	
			</table>
			
			<h4 align="center"> Listas Negras y Personas Pol�ticamente Expuestas </h4>
	
			<table align="center" width="100%" class="ui table segment">
				<tr class="positive">
					<td width="30%">TERRORISTAS (OFAC, ONU)</td>
			...
			<h4 align="center"> Clasificaci�n de Riesgos </h4>
			...
			<table align="center" width="100%" class="ui table segment">
				...
				<tr class="positive">
					<td width="30%">PA�SES DE RIESGO</td>
  ...
  <div class="content">
    	<div class="ui form segment">
			...
			<table id="ContenidoTabla" class="tblReporte" cellspacing="1" cellpadding="3" style="width:100%;">
                <tr>
                    <th id="TituloCotizador" class="titulo" style="padding: 5px; line-height: 200%;" colspan="2">ELIGE UN PA�S</th>
                </tr>
                <tr>
                    <td valign="top" style="width:30%">Pa�s</td>
                    <td> 
...
<div class="ui mini modal" id="ModalActCat"> 
	<div class="content">
	      �Se han actualizado los cat�logos!
	</div
></div>
